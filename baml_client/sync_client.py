...
class BamlStreamClient:
    ...
    def ExtractEmailDetails(
        ...
        email_text: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[partial_types.ExtractedInfo, types.ExtractedInfo]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[partial_types.ExtractedInfo, types.ExtractedInfo](
        raw,
    ...
    def Plans(
        ...
        instructions: str,tools: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[List[partial_types.Tool], List[types.Tool]]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlSyncStream[List[partial_types.Tool], List[types.Tool]](
        raw,
