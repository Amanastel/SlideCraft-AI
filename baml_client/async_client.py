...
class BamlStreamClient:
    ...
    def GenerateQuickOutline(
        ...
        content: str,audience: Optional[str],pages: Optional[str],scenario: Optional[str],tone: Optional[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.StrategicPresentationOutline, types.StrategicPresentationOutline]:
      options: BamlCallOptions = {**self.__baml_options, **(baml_options or {})}
      __tb__ = options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      ...
      return baml_py.BamlStream[partial_types.StrategicPresentationOutline, types.StrategicPresentationOutline](
        raw,
